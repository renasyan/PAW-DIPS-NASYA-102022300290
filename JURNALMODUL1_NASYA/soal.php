...
$nama = $nim = $email = $jurusan = $fakultas = "";
$namaErr = $nimErr = $emailErr = $jurusanErr = $fakultasErr = "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(empty($nama)){
        ...
        $namaErr = "Nama hanya berupa abjad";
    }
    ...
    if(empty($jurusan)){
        $jurusanErr = "Jurusan perlu diisi";
    ...
    if(empty($fakultas)){
        $fakultasErr = "Fakultas perlu diisi";
    }elseif (!preg_match("#^[a-zA-Z\s]+$#",$fakultas)){
        $fakultasErr = "Fakultas hanya berupa abjad";
    }
}
?>
...
<body>
    ...
    <?php
        if ($_SERVER['REQUEST_METHOD'] == "POST" && !$namaErr && !$emailErr && !$nimErr && !$jurusanErr && !$fakultasErr) {
        ?>
